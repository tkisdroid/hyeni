...
public class LocationService extends Service {
    ...
    // v5_silent_cover: 무음 + 폴더블 cover display 호환. MyFirebaseMessagingService
    // 와 동일 ID. sound=null + vibration=false 로 무음, bypassDnd=true 로 cover
    // display 에 알림 노출 → fullScreenIntent 가 RemoteListenActivity launch 가능.
