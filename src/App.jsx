...
import { kakaoLogin, getSession, joinFamily, getMyFamily, unpairChild, saveParentPhones, generateUUID, logout } from "./lib/auth.js";
...
export default function KidsScheduler() {
    ...
    // pushPermission, nativeNotifHealth, bgLocationGranted provided by useNotification below

    // ── Schedules hook (events, academies, memos, stickers, realtime) ────────
    const {
        events, setEvents,
        ...
        handleDeleteEvent,
        updateEvField,
    } = useSchedules({ familyId, authUser, myRole, isParent, setChildPos, setShowKkukReceived });

    // ── Notification hook (push permission, native health, FCM, scheduling) ────
    const {
    ...
    useEffect(() => {
        loadMemoReplies(dateKey, hasMemo);
    }, [familyId, dateKey, hasMemo, loadMemoReplies]);
            ...
            {activeView === "calendar" && <>
                ...
                <div style={{ ...cardSt, marginBottom: 0 }}>
                    <DayTimetable
                        ...
                        onDelete={(id) => handleDeleteEvent(id, dateKey, showNotif)}
