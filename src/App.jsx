              ...
              return (
                <div style={{ width: "100%", maxWidth: parentSectionMaxWidth, padding: "0 14px", boxSizing: "border-box" }}>
                  <section
                    ...
                    style={{
                      position: "relative",
                      background: "linear-gradient(135deg, var(--theme-accent-soft) 0%, var(--bg-base) 60%, var(--theme-accent-soft) 100%)",
                      borderRadius: 22,
                    ...
                    <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 12, position: "relative", zIndex: 1 }}>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          cursor: "pointer",
                          fontFamily: FF,
                          boxShadow: "0 6px 14px color-mix(in srgb, var(--theme-accent) 30%, transparent)",
                          letterSpacing: 0,
                          whiteSpace: "nowrap",
                          maxWidth: "100%",
                        }}
                ...
                >
                    ...
                    <button
                        ...
                        style={{
                            ...
                            gap: 14,
                            padding: "16px 18px",
                            background: "linear-gradient(135deg, var(--bg-base) 0%, var(--theme-accent-soft) 100%)",
                            border: "1px solid var(--theme-accent-line)",
                            borderRadius: 24,
                            boxShadow: "var(--shadow-soft, 0 8px 24px rgba(31, 24, 28, 0.06))",
                            cursor: "pointer",
