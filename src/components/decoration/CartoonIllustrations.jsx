...
// 빈 문자열 ariaLabel 은 "이 일러스트는 장식용" 의 의미로 처리한다.
// role="img" + aria-label="" 는 WCAG 4.1.2 위반이라, 이 경우 aria-hidden
// 만 부여해 스크린 리더 노출을 막는다. 의미 있는 라벨이 들어오면 정상적인
// img role + label 로 표시된다.
function svgA11yProps(ariaLabel) {
